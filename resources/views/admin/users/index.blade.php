  ...
  <div class="col-xl-12">
      <div class="card mg-b-20">
          <div class="card-header pb-0">
                  <a href={{url('users/user/create') }} class="modal-effect btn btn-sm btn-primary" style="color:white"><i
                      ...
                      <tbody>
                          ...
                          @foreach ($users as $item)
                              ...
                              <tr>
                                  ...
                                  <td ><img src="{{ asset($item->attachmentRelation[0]->path) }} "
                                          alt="avatar" height="60" style="border-radius:20px;"></td>
                              @else
                                  <td><img src="{{ asset('admin/app-assets/images/profile.png') }}"
                                          alt="avatar" height="60"></td>
                              @endisset
                                  <td>{{ $item->name }} </td>
                                  <td>{{ $item->email }}</td>
                                  <td>{{ $item->number }}</td>
                                  ...
                                  <td>
                                    ...
                                    <a href="{{ route('user.edit',$item->id) }}"  class="btn round btn-outline-primary">
                                      <i
