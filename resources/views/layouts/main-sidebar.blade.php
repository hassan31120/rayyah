...
<aside class="app-sidebar sidebar-scroll" style=" position: fixed;
    ...
    bottom: 0;">
        ...
        <ul class="side-menu">
            ...
            <li class="slide {{ Request::segment(1) == 'users' || 'deliverys' ? 'active' : '' }}"">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'users')) }}">{{ __('admin.users') }}</a></li>

                    <li><a class="slide-item" href="{{ url('/' . ($page = 'deliverys')) }}">{{ __('admin.deliver') }}</a></li>
                </ul>
            </li>
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'complains')) }}">{{ __('admin.complaining') }}</a></li>

                    <li><a class="slide-item" href="{{ url('/' . ($page = 'contacts')) }}">{{ __('admin.contac') }}</a></li>
                </ul>
            </li>
        </ul>
    </div>
